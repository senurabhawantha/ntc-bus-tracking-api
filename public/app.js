...
// // ---- helpers ----
// function round3(n) {
//   return Math.round(n * 100) / 100; // 2 decimals ~1km for better cache hits
// }
...
//   // first fill immediately, then every 20s (keeps API load sensible)
//   refreshLocationCells();
//   locIntervalId = setInterval(refreshLocationCells, 20000);

//   // animation loop — speed tuned so motion is obvious but not jittery
//   const step = () => {
//     routeBuses.forEach(bus => {
