...
const mongoUri = 'mongodb+srv://senurabawantha_db_user:koOuQbtRbIJcI4sd@bus-traking-api.hxctmjs.mongodb.net/bus-traking-api?retryWrites=true&w=majority&appName=bus-traking-api'; // Use your MongoDB URI here
...
// const mongoUri = 'mongodb+srv://senurabawantha_db_user:koOuQbtRbIJcI4sd@bus-traking-api.hxctmjs.mongodb.net/bus-traicking-api?retryWrites=true&w=majority&appName=bus-traking-api'; // Replace with your Mongo URI
...
//       status: Math.random() < 0.7 ? "On Time" : "Delayed", // random initial status
//       current_location: {
//         latitude: 6.9271 + Math.random() * 0.05, // random around Colombo
//         longitude: 79.8612 + Math.random() * 0.05
//       }
//     });
//   }
